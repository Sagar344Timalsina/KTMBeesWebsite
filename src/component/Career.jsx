    ...
    return (
        <>
            ...
            <main className='py-24 px-6 md:py-24 md:px-12 lg:px-96 lg:py-24 items-center bg-light_yellow'>
                <Text className='text-center font-bold text-xl text-yellow mb-14'>{career.jobTitle}</Text>
                <div className='  flex flex-col '>
                    ...
                    <Text className='flex items-center gap-1'><BiTimeFive />{career.jobType}</Text>
