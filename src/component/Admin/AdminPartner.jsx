...
const AdminPartner = () => {
  ...
  const handleUpdate = (data, id) => {
    ...
    if (preimgUrl !== imageUrl) deleteStorageImage(preimgUrl);
    fetchDatas();
  };
  ...
  return (
    <main className="flex items-center justify-center flex-col">
      <section className="text-4xl my-6 font-sans font-bold">
        Partner Section
      </section>
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mb-5">
              <Controller
                name="subheading"
                control={control}
                rules={{ required: "Fill up the subHeading" }}
                render={({ field }) => (
                  <TextInput
                    control={control}
                    {...field}
                  ...
                  <>
                    ...
                    >
                      {imageUrl && imageUrl !== null ? (
                        <img src={imageUrl} alt="Uploaded Images" />
                      ) : null}
                      {imageUrl && imageUrl !== null ? (
                        <button
                ...
                <tr key={data.id}>
                  ...
                  <td>
                    <Button
                      ...
                      onClick={() => handleDeleteButton(data.id, data.image)}
                    >
