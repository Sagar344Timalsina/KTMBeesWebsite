...
const PartnerUs = () => {
  return (
    <main className='w-[70%] bg-white mx-auto  py-[4rem] gap-4 flex items-center justify-center'>
      <section className=''>
        <img className='' src={HoneyComb} alt="HoneyCombImage" />
      </section>
      <section className='w-[50%]'>
        <h3 className='font-sans font-[700] text-dark_gray text-3xl'>Partner With Us</h3>
        <h1 className='text-yellow font-sans font-[700] text-4xl'>Get worry-free MVP</h1>
        <p className='pt-4 pb-6 tracking-[.05rem] text-lg max-w-lg text-dark_gray'>Our combined experience of over 40 years’ diligent team is more than happy to help you
