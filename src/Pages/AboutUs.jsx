...
const AboutUs = () => {
  ...
  const [selectedAccordian, setSelectedAccordian] =
    useState("Mission & Vision");
    ...
    <div className="bg-light_yellow">
      ...
      <main className="bg-light_yellow pt-15">
        <section className="pt-14">
          <div className="flex flex-col h-auto  mt-10 mx-auto bg-white justify-center items-center px-1 pt-9 pb-9 py-1.8rem gap-[0.5rem]">
        ...
        <section>
          <Accordion
            ...
            className="display__accordian pb-8"
            onChange={setSelectedAccordian}
          >
          ...
          <Tabs
            ...
            className="mx-auto h-auto display__tabs hidden flex flex-col"
            styles={(theme) => ({
              tab: {
                "&[data-active]": {
                  color: "#F0B62F",
          ...
          >
            <Tabs.List className="mt-[3.2rem] justify-center w-fit mx-auto font-bold">
              ...
              <Tabs.Tab
                value="Team"
                color="yellow"
                className=" p-4 w-auto mr-[0.5rem] sm:mr-[2.8rem] h-auto font-sans text-xs sm:text-lg leading-[23px] tracking-[0.047rem] "
              >
                Team
              </Tabs.Tab>
            </Tabs.List>
            ...
            <Tabs.Panel
              value={selectedItem}
              pt="xl"
              className=" w-[60%] mx-auto grid grid-cols-12 gap-16"
            >
              {selectedItem === "Team" &&
                displayTeams.map((data) => (
