    ...
    <div className="bg-light_yellow">
      ...
      <main>
        <section className="pt-14">
          ...
          <Tabs
            defaultValue="Mission & Vision"
            className="mx-auto h-auto display__tabs hidden"
            styles={(theme) => ({
              tab: {
                "&[data-active]": {
                  color: "#F0B62F",
          ...
          >
            ...
            {display.map((content) => (
              <Tabs.Panel
                ...
                value={content.title}
                pt="xl"
                className="pb-10 w-3/5 mx-auto"
              >
                {/* <Text className=' w-auto h-7 font-sans font-bold  text-sm sm:text-lg leading-7 text-dark_gray'>{content.name}</Text> */}
                <Text className=" mt-3 w-auto h-auto pb-10 font-sans font-normal text-sm sm:text-lg leading-7 text-justify  text-dark_gray sm:tracking-[0.047rem]">
                  {content.description}
                </Text>
              </Tabs.Panel>
            ))}
