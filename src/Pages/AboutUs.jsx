      ...
      <main className='bg-light_yellow'>
        ...
        <section>
          ...
          <Tabs defaultValue="Mission & Vision" onTabChange={setSelectedItem} className='mx-auto h-auto display__tabs hidden flex flex-col' styles={(theme) => ({
            ...
            {display.map((content) => (
              <Tabs.Panel defaultValue="Mission & Vision" key={content.id} value={content.title} pt='xl' className='mb-10 w-[60%] mx-auto' >
            ...
            <Tabs.Panel value={selectedItem} pt='xl' className='mb-10 w-[60%] mx-auto grid grid-cols-12' >
