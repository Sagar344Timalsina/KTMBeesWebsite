      ...
      <main className='bg-light_gray'>
        <section>
          ...
          <div className='flex flex-col h-40  mt-10 mx-auto bg-white justify-center items-center px-1 py-1.8rem gap-[0.5rem]'>
            ...
            <Text className='w-[30.75rem] h-[2.3rem] font-bold text-[1rem] sm:text-[2rem] leading-9 text-center tracking-wide text-black font-sans'>Technology that works for you</Text>
